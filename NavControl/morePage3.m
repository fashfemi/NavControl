...
-(IBAction)switchPage:(id)sender{
    if(self.page==nil){
        moreFinalpage* pageIn=[[moreFinalpage alloc]initWithNibName:@"moreFinalpage" bundle:[NSBundle mainBundle]];
        self.page=pageIn;
    }
    [valueHolder transit1:self.navigationController View2Show:page];
}
