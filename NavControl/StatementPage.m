...
-(IBAction)switchPage:(id)sender{
    UIAlertView* alert=[[UIAlertView alloc]initWithTitle:@"Statement sent!" message:@"Your statement has been sent to your registered email" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
    [alert show];
    if(self.menu==nil){
        AcctMenu* menuIn=[[AcctMenu alloc]initWithNibName:@"AcctMenu" bundle:[NSBundle mainBundle]];
        self.menu=menuIn;
    }
